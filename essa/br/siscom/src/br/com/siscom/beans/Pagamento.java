 ...
 */
@Entity
@Table(name = "pagamento", catalog = "siscomrefatorado", schema = "")
@NamedQueries({
    ...
    @NamedQuery(name = "Pagamento.findByVlrJurosPagamento", query = "SELECT p FROM Pagamento p WHERE p.vlrJurosPagamento = :vlrJurosPagamento"),
...
@NamedQuery(name = "Pagamento.findByCodFornecedor", query = "SELECT p FROM Pagamento p WHERE p.codFornecedor = :codFornecedor") , //PODIA TER FEITP COLANDO A DE CIMA DENTRO DE UM AND
        @NamedQuery(name = "Pagamento.findBetweenVencimento", query = "SELECT p FROM Pagamento p WHERE p.dataPagamento is null and p.vencimentoPagamento BETWEEN :dataIni AND :dataFim")})
public class Pagamento implements Serializable {
    ...
    @Column(name = "VLR_JUROS_PAGAMENTO")
    private Double vlrJurosPagamento;
    ...
    public Double getVlrJurosPagamento() {
        return vlrJurosPagamento;
    }

    public void setVlrJurosPagamento(Double vlrJurosPagamento) {
        Double oldVlrJurosPagamento = this.vlrJurosPagamento;
        this.vlrJurosPagamento = vlrJurosPagamento;
        changeSupport.firePropertyChange("vlrJurosPagamento", oldVlrJurosPagamento, vlrJurosPagamento);
    }
 ...
 public Integer getCodFornecedor() {
    ...
    public String toString() {
        return "br.com.siscom.beans.financeiro.Pagamento[ codPagamento=" + codPagamento + " ]";
    }
