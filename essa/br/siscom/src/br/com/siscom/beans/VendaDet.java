 ...
 */
@Entity
@Table(name = "venda_det", catalog = "siscomrefatorado", schema = "")
@NamedQueries({
    ...
    @NamedQuery(name = "VendaDet.findByQtdeVendaDet", query = "SELECT v FROM VendaDet v WHERE v.qtdeVendaDet = :qtdeVendaDet"),
...
public class VendaDet implements Serializable {
    ...
    public String toString() {
        return "br.com.siscom.beans.VendaDet[ vendaDetPK=" + vendaDetPK + " ]";
    }
