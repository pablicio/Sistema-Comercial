 ...
 */
@Entity
@Table(name = "nfe_det", catalog = "siscomrefatorado", schema = "")
@NamedQueries({
    @NamedQuery(name = "NfeDet.findAll", query = "SELECT n FROM NfeDet n"),
    @NamedQuery(name = "NfeDet.findByNumNfeCab", query = "SELECT n FROM NfeDet n WHERE n.nfeDetPK.numNfeCab = :numNfeCab"),
    @NamedQuery(name = "NfeDet.findByCodProduto", query = "SELECT n FROM NfeDet n WHERE n.nfeDetPK.codProduto = :codProduto"),
    @NamedQuery(name = "NfeDet.findByQtdeNfeDet", query = "SELECT n FROM NfeDet n WHERE n.qtdeNfeDet = :qtdeNfeDet"),
    @NamedQuery(name = "NfeDet.findByVlrUnitNfeDet", query = "SELECT n FROM NfeDet n WHERE n.vlrUnitNfeDet = :vlrUnitNfeDet"),
    @NamedQuery(name = "NfeDet.findByVlrTotalNfeDet", query = "SELECT n FROM NfeDet n WHERE n.vlrTotalNfeDet = :vlrTotalNfeDet")})
public class NfeDet implements Serializable {
    ...
    @JoinColumn(name = "NUM_NFE_CAB", referencedColumnName = "NUM_NFE_CAB", insertable = false, updatable = false)
    ...
    public NfeDet(int numNfeCab, String codProduto) {
        this.nfeDetPK = new NfeDetPK(numNfeCab, codProduto);
    }
    ...
    public String toString() {
        return "br.com.siscom.beans.estoque.NfeDet[ nfeDetPK=" + nfeDetPK + " ]";
    }
