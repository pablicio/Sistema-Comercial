...
public class PlanoContaView extends JPanel {
    ...
    private void initComponents() {
        ...
        descricaoPlanoContaLabel.setText("Descrição:");

        descricaoPlanoContaField.setText("");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(descricaoPlanoContaField, javax.swing.GroupLayout.DEFAULT_SIZE, 376, Short.MAX_VALUE))
    ...
    private void refreshButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_refreshButtonActionPerformed
        ...
        list.clear();
        list.addAll(data);
        masterScrollPane.setBackground(Color.yellow);
        masterTable.setBackground(Color.yellow);
    }//GEN-LAST:event_refreshButtonActionPerformed

    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        int[] selected = masterTable.getSelectedRows();
        List<br.com.siscom.beans.PlanoConta> toRemove = new ArrayList<br.com.siscom.beans.PlanoConta>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            br.com.siscom.beans.PlanoConta p = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(p);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        br.com.siscom.beans.PlanoConta p = new br.com.siscom.beans.PlanoConta();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<br.com.siscom.beans.PlanoConta> merged = new ArrayList<br.com.siscom.beans.PlanoConta>(list.size());
            for (br.com.siscom.beans.PlanoConta p : list) {
    ...
    private java.util.List<br.com.siscom.beans.PlanoConta> list;
